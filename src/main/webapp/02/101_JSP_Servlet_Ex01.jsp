...
<form method="post" action="../Join_servlet">
    ...
    <label for="chk_mail">메일 정보 수신 여부 : </label> <input type="radio" name= "chk_mail" value = "1">수신
    <input type="radio" name="chk_mail" value="0"> 거부<br><br>
    <label for="content">간단한 가입 인사를 적어라: </label><br>
