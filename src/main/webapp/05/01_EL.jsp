...
<!--  EL 을 이용할때 서버객체의 내용을 출력하고자 할때, 어떤 객체인지 명시하지 않고, 애트리뷰터 이름만
사용하다면, 사용하려는 애트리 뷰트가 있는 객체를 순서(pageContext -> request -> session ->application)
데로 검사하여 가장 먼저 발견된 내용이 출력됩니다. 
